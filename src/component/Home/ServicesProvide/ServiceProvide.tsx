            ...
            <Grid item xs={12} md={6} key={index}>
              ...
              >
                ...
                <div className="flex flex-col items-start justify-start">
                  <div className='flex items-center justify-center mt-5 lg:w-2/3'>
                    <div className="flex group hover:!bg-white transition-all duration-300 flex-col items-center justify-center min-h-[60px] min-w-[60px] !bg-yellow-500 border-4 !border-yellow-500 rounded-full mx-3 relative overflow-hidden lg:min-h-[80px] lg:min-w-[80px]">
                      <ManageAccounts className="!text-3xl !text-white group-hover:!text-yellow-primary group-hover:!scale-1200" />
                    </div>
                    <p className="w-full flex items-center my-2 text-lg font-bold">
                      {service.title}
                    </p>
                  </div>
                  <p className="cursor-pointer text-center mt-5 lg:text-left transition-all text-slate-500">
                    {service.description}
                  </p>
                </div>
              </div>
